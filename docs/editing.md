...
| I want to                                | Go to                                                                                                                                                            |
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Post photos                              | Photos → pick or create an album, upload. Uploads are converted to webp and lose their location data. Tick "Featured" and pick the highlights for the home page. |
